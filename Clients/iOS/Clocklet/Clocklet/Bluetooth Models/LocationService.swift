...
struct ClockLocation: Codable, JSONCharacteristic, CustomStringConvertible{
    ...
    var description: String{
        return "\(String(lat ?? 0)),\(String(lng ?? 0)) - \(placeName ?? "nowhere")"
    }
    ...
    static let nullIsland = ClockLocation(configured: false, lat: 0.0, lng: 0.0, timeZone: "UTC", placeName: "Null Island")
    ...
    static let northPole = ClockLocation(configured: true, lat: 85.05, lng: 0, timeZone: "UTC", placeName: "North Pole")
    static let southPole = ClockLocation(configured: true, lat: -85.05, lng: 0, timeZone: "UTC", placeName: "South Pole")
}
